...
def body2(sigma, loopCount2):
    ...
    sigma = sigma3_ogn
    sigma3_choose3 = sigma
    sigma = tf.matmul(sigma3_choose1, tf.constant(0.3333333333333333*np.identity(21), dtype=tf.float64))
    sigma = tf.add(sigma, tf.matmul(sigma3_choose2, tf.constant(0.3333333333333333*np.identity(21), dtype=tf.float64)))
    sigma = tf.add(sigma, tf.matmul(sigma3_choose3, tf.constant(0.3333333333333333*np.identity(21), dtype=tf.float64)))
...
with tf.Session() as sess:
    ...
    sigma = tf.matmul(sigma1_choose1, tf.constant(0.5*np.identity(21), dtype=tf.float64))
    sigma = tf.add(sigma, tf.matmul(sigma1_choose2, tf.constant(0.5*np.identity(21), dtype=tf.float64)))
